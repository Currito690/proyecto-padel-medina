> **CORTE REALIZADO el 2026-09-14 a las 12:22 UTC (14:22 hora local):** ventana de mantenimiento de 1 min 38 s; datos resincronizados (copia fresca idéntica a la nube: 122 usuarios, 252 reservas, 88 fichajes, 251 bloqueos, 38 clases); pruebas OK (API, login, Google, tiempo real, storage, funciones, email por Resend, firma Redsys); ninguna escritura en la nube tras la copia. Supabase cloud queda como respaldo de lectura unos días y después se pausa/borra (ver limpieza en §9).
