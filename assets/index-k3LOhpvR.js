const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BookingDashboard-CLv3muh2.js","assets/pdf-vendor-CcZKRWo-.js","assets/rolldown-runtime-km5iIlDX.js","assets/supabase-vendor-DzZbqjtm.js","assets/react-vendor-5-kJuc0W.js","assets/DateSelector-BqJuFU0O.js","assets/CartContext-_wneAiMp.js","assets/supabase-BhMSj0Ru.js","assets/notify-iKlTVhCs.js","assets/MyBookings-DtWcOl_M.js","assets/Profile-TQ2aytie.js","assets/AdminDashboard-C1ePFJ5H.js","assets/vendor-VW-dUZNH.js","assets/names-CP0XsZ--.js","assets/Login-CN207FUk.js","assets/utils-vendor-DP0mq0mv.js","assets/PaymentGateway-DoAN2xF4.js","assets/TournamentRegistration-O7N1qujb.js","assets/TournamentBracket-DTXs683d.js","assets/Cart-Cb2Q3Nip.js","assets/SharedPayment-DTuqAYGL.js","assets/PrivacyPolicy-INTw7LCJ.js","assets/Tournaments-DQ0GPSry.js","assets/ResetPassword-DTgCpZU4.js","assets/ShopLayout-Sh0PkBex.js","assets/shopTheme-D8cqsbiN.js","assets/Tienda-C-0S8_cY.js","assets/shopFormat-Df0OgZra.js","assets/ProductoDetalle-CtpHglnc.js","assets/ShopCart-D2dhfglW.js","assets/ShopCheckout-CnnDq6S5.js","assets/ShopOrderResult-D2SvwX5i.js","assets/MonitorView-BrTG92Ii.js"])))=>i.map(i=>d[i]);
import{r as z}from"./rolldown-runtime-km5iIlDX.js";import{a as N,c as B,f as V,i as S,n as W,o as d,p as F,r as H,s as U,t as $}from"./react-vendor-5-kJuc0W.js";import{a as m,i as C}from"./pdf-vendor-CcZKRWo-.js";import"./supabase-vendor-DzZbqjtm.js";import{t as f}from"./supabase-BhMSj0Ru.js";import{n as K,t as q}from"./CartContext-_wneAiMp.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const x of l.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&a(x)}).observe(document,{childList:!0,subtree:!0});function s(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(i){if(i.ep)return;i.ep=!0;const l=s(i);fetch(i.href,l)}})();var Y=V(),r=z(F(),1),e=$(),M=(0,r.createContext)(),G=["admin@padelmedina.com"],X=["lolo@padelmedina.com"],P=(t,n)=>({id:t.id,email:t.email,name:t.user_metadata?.name||t.email.split("@")[0],role:X.includes(t.email)?"monitor":n||(G.includes(t.email)?"admin":"client")}),Z=async t=>{try{const n=new AbortController,s=setTimeout(()=>n.abort(),2500),{data:a}=await f.from("profiles").select("role").eq("id",t).abortSignal(n.signal).maybeSingle();return clearTimeout(s),a?.role||null}catch{return null}};function J({children:t}){const[n,s]=(0,r.useState)(null),[a,i]=(0,r.useState)(!0);(0,r.useEffect)(()=>{let o=!1;const c=g=>{if(!g){o||s(null);return}o||s(P(g,null)),Z(g.id).then(y=>{o||!y||s(_=>_&&_.id===g.id?P(g,y):_)})},u=setTimeout(()=>{o||i(!1)},5e3);f.auth.getSession().then(({data:{session:g}})=>{clearTimeout(u);const y=g?.user;c(y?.email_confirmed_at?y:null),o||i(!1)}).catch(()=>{clearTimeout(u),o||(s(null),i(!1))});const{data:{subscription:b}}=f.auth.onAuthStateChange((g,y)=>{if(g==="INITIAL_SESSION")return;const _=y?.user;if(_&&!_.email_confirmed_at){o||s(null);return}c(_||null)});return()=>{o=!0,clearTimeout(u),b.unsubscribe()}},[]);const l=async()=>{await f.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})},x=async(o,c)=>{const{error:u}=await f.auth.signInWithPassword({email:o,password:c});if(u)throw u},v=async(o,c,u,b)=>{const{error:g}=await f.auth.signUp({email:o,password:c,options:{data:{name:u||"",phone:b||""},emailRedirectTo:window.location.origin}});if(g)throw g},j=async(o,c)=>{const{error:u}=await f.auth.verifyOtp({email:o,token:c,type:"signup"});if(u)throw u},w=async o=>{const{error:c}=await f.auth.resetPasswordForEmail(o,{redirectTo:`${window.location.origin}/reset-password`});if(c)throw c},p=async o=>{const{error:c}=await f.auth.updateUser({password:o});if(c)throw c},h=async()=>{await f.auth.signOut(),s(null)};return a?(0,e.jsx)("div",{style:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#F8FAFC"},children:(0,e.jsxs)("div",{style:{textAlign:"center"},children:[(0,e.jsx)("div",{style:{width:"40px",height:"40px",border:"3px solid #DCFCE7",borderTopColor:"#16A34A",borderRadius:"50%",animation:"spin 0.8s linear infinite",margin:"0 auto 1rem"}}),(0,e.jsx)("style",{children:"@keyframes spin { to { transform: rotate(360deg); } }"}),(0,e.jsx)("p",{style:{color:"#94A3B8",fontWeight:600,margin:0},children:"Cargando..."})]})}):(0,e.jsx)(M.Provider,{value:{user:n,loginWithGoogle:l,loginWithPassword:x,signupWithEmail:v,verifySignupOtp:j,resetPassword:w,updatePassword:p,logout:h,loading:a},children:t})}var Q=()=>(0,r.useContext)(M),ee="BPkGxuT7mSIsUrU2X2rOuyRWZCSBZorYr5ZfIaMmrmdQrXTQRAEX15k9v3JQ4Zfcad5Oq13Q5ThPRkCVcgPKAgU";function te(t){const n=(t+"=".repeat((4-t.length%4)%4)).replace(/-/g,"+").replace(/_/g,"/"),s=atob(n);return Uint8Array.from(s,a=>a.charCodeAt(0))}async function re(t,n){if(!("serviceWorker"in navigator)||!("PushManager"in window)||Notification.permission==="denied")return null;try{const s=await navigator.serviceWorker.register("/sw.js",{scope:"/"}),a=await s.pushManager.getSubscription();if(a&&await a.unsubscribe(),await Notification.requestPermission()!=="granted")return null;const i=await s.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:te(ee)}),l=i.toJSON();return await t.from("push_subscriptions").upsert({user_id:n,endpoint:l.endpoint,subscription:l},{onConflict:"endpoint"}),i}catch(s){return console.warn("Push subscription error:",s),null}}function ae(){const t=B(),{count:n}=K(),s=a=>a==="/tienda"?t.pathname.startsWith("/tienda"):t.pathname===a;return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)("style",{children:`
        .bottom-nav {
          position: fixed;
