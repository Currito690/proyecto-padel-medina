import{r as T}from"./rolldown-runtime-km5iIlDX.js";import{p as P,r as _,t as q}from"./react-vendor-5-kJuc0W.js";import"./pdf-vendor-CcZKRWo-.js";import"./supabase-vendor-DzZbqjtm.js";import"./supabase-BhMSj0Ru.js";import{l as I}from"./index-U7r_2Z23.js";import{t as V}from"./utils-vendor-DP0mq0mv.js";var r=T(P(),1),c=g=>g?V.sanitize(g,{ALLOWED_TAGS:[],ALLOWED_ATTR:[]}).trim():"",e=q(),K=()=>{const{loginWithGoogle:g,loginWithPassword:F,signupWithEmail:N,verifySignupOtp:C,resetPassword:A}=I(),[t,S]=(0,r.useState)(!0),[m,h]=(0,r.useState)(1),[p,x]=(0,r.useState)(!1),[b,E]=(0,r.useState)(""),[o,f]=(0,r.useState)(""),[v,B]=(0,r.useState)(""),[u,z]=(0,r.useState)(""),[j,y]=(0,r.useState)(""),[l,d]=(0,r.useState)(!1),[w,n]=(0,r.useState)(null),[k,s]=(0,r.useState)(""),D=async i=>{i.preventDefault(),d(!0),n(null),s("");try{t?await F(c(o),u):(await N(c(o),u,c(b),c(v)),s(`¡Cuenta creada! Hemos enviado un código de verificación a ${o}. Introdúcelo para activar tu cuenta.`),h(2))}catch(a){n(a.message||"Error al procesar la solicitud")}finally{d(!1)}},L=async i=>{i.preventDefault(),d(!0),n(null),s("");try{await A(c(o)),s(`Si existe una cuenta con ${o}, te hemos enviado un email con un enlace para restablecer tu contraseña.`)}catch(a){n(a.message||"No se pudo enviar el email de recuperación")}finally{d(!1)}},M=async i=>{i.preventDefault(),d(!0),n(null);try{await C(o,c(j))}catch{n("Código incorrecto o expirado. Revisa tu correo e inténtalo de nuevo.")}finally{d(!1)}},W=()=>(0,e.jsxs)("div",{className:"login-brand",children:[(0,e.jsx)("div",{className:"login-blob login-blob-1"}),(0,e.jsx)("div",{className:"login-blob login-blob-2"}),(0,e.jsx)("div",{className:"login-blob login-blob-3"}),(0,e.jsx)("h1",{className:"login-brand-title",children:"Padel Medina"}),(0,e.jsx)("p",{className:"login-brand-sub",children:"Tu pista te espera"}),(0,e.jsx)("ul",{className:"login-features",children:["Reserva en segundos","Pistas de pádel y pickleball","Horarios de 09:00 a 22:00"].map(i=>(0,e.jsxs)("li",{className:"login-feature-item",children:[(0,e.jsx)("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"rgba(255,255,255,0.9)",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:(0,e.jsx)("polyline",{points:"20 6 9 17 4 12"})}),i]},i))})]});return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)("style",{children:`
        /* ── Login layout ── */
        .login-page {
          min-height: 100vh;
          display: flex;
