const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BookingDashboard-Bwl-6rkr.js","assets/pdf-vendor-Dw8VLciX.js","assets/rolldown-runtime-km5iIlDX.js","assets/supabase-vendor-DzZbqjtm.js","assets/react-vendor-D1tGIDv5.js","assets/schedule-BFLRVecB.js","assets/supabase-W-NFtADY.js","assets/notify-KNkcmvlb.js","assets/MyBookings-BvMgqfmm.js","assets/Profile-DkJAp65y.js","assets/AdminDashboard-DrIegURo.js","assets/vendor-drJjT9YC.js","assets/names-B8S8TWSr.js","assets/Login-BJUUxtZf.js","assets/utils-vendor-DdvYbYg2.js","assets/PaymentGateway-cqgVu_fy.js","assets/TournamentRegistration-uOBVEToL.js","assets/TournamentBracket-D1OMlznl.js","assets/Cart-CZn-D9yl.js","assets/SharedPayment-Jpp_yeEq.js","assets/PrivacyPolicy-DqRiR-Cw.js","assets/Tournaments-CLZSHH3y.js","assets/ResetPassword-DQS3AqHQ.js","assets/MonitorView-ByiDnFid.js"])))=>i.map(i=>d[i]);
import{r as F}from"./rolldown-runtime-km5iIlDX.js";import{a as W,c as B,f as V,i as S,n as H,o as m,p as U,r as Y,s as J,t as Q}from"./react-vendor-D1tGIDv5.js";import{a as g,i as D}from"./pdf-vendor-Dw8VLciX.js";import"./supabase-vendor-DzZbqjtm.js";import{t as x}from"./supabase-W-NFtADY.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const p of c.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&r(p)}).observe(document,{childList:!0,subtree:!0});function s(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function r(i){if(i.ep)return;i.ep=!0;const c=s(i);fetch(i.href,c)}})();var $=V(),n=F(U(),1),X=["lolo@padelmedina.com"],e=Q(),z=(0,n.createContext)(),G=["admin@padelmedina.com"],P=(t,a)=>({id:t.id,email:t.email,name:t.user_metadata?.name||t.email.split("@")[0],role:X.includes(t.email)?"monitor":a||(G.includes(t.email)?"admin":"client")}),q=async t=>{try{const a=new AbortController,s=setTimeout(()=>a.abort(),2500),{data:r}=await x.from("profiles").select("role").eq("id",t).abortSignal(a.signal).maybeSingle();return clearTimeout(s),r?.role||null}catch{return null}};function K({children:t}){const[a,s]=(0,n.useState)(null),[r,i]=(0,n.useState)(!0);(0,n.useEffect)(()=>{let o=!1;const l=f=>{if(!f){o||s(null);return}o||s(P(f,null)),q(f.id).then(j=>{o||!j||s(w=>w&&w.id===f.id?P(f,j):w)})},u=setTimeout(()=>{o||i(!1)},5e3);x.auth.getSession().then(({data:{session:f}})=>{clearTimeout(u);const j=f?.user;l(j?.email_confirmed_at?j:null),o||i(!1)}).catch(()=>{clearTimeout(u),o||(s(null),i(!1))});const{data:{subscription:_}}=x.auth.onAuthStateChange((f,j)=>{if(f==="INITIAL_SESSION")return;const w=j?.user;if(w&&!w.email_confirmed_at){o||s(null);return}l(w||null)});return()=>{o=!0,clearTimeout(u),_.unsubscribe()}},[]);const c=async()=>{await x.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})},p=async(o,l)=>{const{error:u}=await x.auth.signInWithPassword({email:o,password:l});if(u)throw u},v=async(o,l,u,_)=>{const{error:f}=await x.auth.signUp({email:o,password:l,options:{data:{name:u||"",phone:_||""},emailRedirectTo:window.location.origin}});if(f)throw f},b=async(o,l)=>{const{error:u}=await x.auth.verifyOtp({email:o,token:l,type:"signup"});if(u)throw u},y=async o=>{const{error:l}=await x.auth.resetPasswordForEmail(o,{redirectTo:`${window.location.origin}/reset-password`});if(l)throw l},d=async o=>{const{error:l}=await x.auth.updateUser({password:o});if(l)throw l},h=async()=>{await x.auth.signOut(),s(null)};return r?(0,e.jsx)("div",{style:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#F8FAFC"},children:(0,e.jsxs)("div",{style:{textAlign:"center"},children:[(0,e.jsx)("div",{style:{width:"40px",height:"40px",border:"3px solid #DCFCE7",borderTopColor:"#16A34A",borderRadius:"50%",animation:"spin 0.8s linear infinite",margin:"0 auto 1rem"}}),(0,e.jsx)("style",{children:"@keyframes spin { to { transform: rotate(360deg); } }"}),(0,e.jsx)("p",{style:{color:"#94A3B8",fontWeight:600,margin:0},children:"Cargando..."})]})}):(0,e.jsx)(z.Provider,{value:{user:a,loginWithGoogle:c,loginWithPassword:p,signupWithEmail:v,verifySignupOtp:b,resetPassword:y,updatePassword:d,logout:h,loading:r},children:t})}var Z=()=>(0,n.useContext)(z),ee="BPy2fyS_zj3l1gFvsxHUYDuQrfXZX1eQ2Q_FOtd2XRtO0UQ7YCcFfCdtvvkaerL8CybPsWveFjtnxiiC7IGPda8";function te(t){const a=(t+"=".repeat((4-t.length%4)%4)).replace(/-/g,"+").replace(/_/g,"/"),s=atob(a);return Uint8Array.from(s,r=>r.charCodeAt(0))}async function re(t,a){if(!("serviceWorker"in navigator)||!("PushManager"in window)||Notification.permission==="denied")return null;try{const s=await navigator.serviceWorker.register("/sw.js",{scope:"/"}),r=await s.pushManager.getSubscription();if(r&&await r.unsubscribe(),await Notification.requestPermission()!=="granted")return null;const i=await s.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:te(ee)}),c=i.toJSON();return await t.from("push_subscriptions").upsert({user_id:a,endpoint:c.endpoint,subscription:c},{onConflict:"endpoint"}),i}catch(s){return console.warn("Push subscription error:",s),null}}var M=(0,n.createContext)(),L="padelmedina_cart",k=300*1e3,R=(t,a)=>t.addedAt?a-t.addedAt>=k:!1,ae=({children:t})=>{const[a,s]=(0,n.useState)(()=>{try{const d=localStorage.getItem(L),h=d?JSON.parse(d):[],o=Date.now();return h.map(l=>l.addedAt?l:{...l,addedAt:o}).filter(l=>!R(l,o))}catch{return[]}}),[,r]=(0,n.useState)(0);(0,n.useEffect)(()=>{try{localStorage.setItem(L,JSON.stringify(a))}catch{}},[a]),(0,n.useEffect)(()=>{const d=setInterval(()=>{const h=Date.now();s(o=>{const l=o.filter(u=>!R(u,h));return l.length===o.length?o:l}),r(o=>(o+1)%1e3)},1e3);return()=>clearInterval(d)},[]);const i=d=>`${d.courtId}-${d.date}-${d.timeSlot}`,c=d=>{s(h=>{const o=i(d);return h.some(l=>l.cartId===o)?h:[...h,{...d,cartId:o,addedAt:Date.now()}]})},p=d=>{s(h=>h.filter(o=>o.cartId!==d))},v=()=>s([]),b=a.reduce((d,h)=>d+(Number(h.price)||0),0),y=d=>d?.addedAt?Math.max(0,d.addedAt+k-Date.now()):k;return(0,e.jsx)(M.Provider,{value:{items:a,addItem:c,removeItem:p,clearCart:v,total:b,count:a.length,getRemainingMs:y},children:t})},ne=()=>{const t=(0,n.useContext)(M);if(!t)throw new Error("useCart must be used within CartProvider");return t};function ie(){const t=B(),{count:a}=ne(),s=r=>t.pathname===r;return(0,e.jsxs)(e.Fragment,{children:[(0,e.jsx)("style",{children:`
        .bottom-nav {
          position: fixed;
